...
local MainFileName = "SlientAimBloxFruit"
...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/KimWoramet/script/main/Library.Lua'))()
local ThemeManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/KimWoramet/script/main/ThemeManager.Lua'))()
local SaveManager = loadstring(game:HttpGet('https://raw.githubusercontent.com/KimWoramet/script/main/SaveManager.Lua'))()

local Window = Library:CreateWindow("Z2Q Slient Aim")
...
local MainBOX = GeneralTab:AddLeftTabbox("Main") do
    ...
    Main:AddDropdown("TargetPart", {Text = "Target Part", Default = SilentAimSettings.TargetPart, Values = {"HumanoidRootPart"}}):OnChanged(function()
